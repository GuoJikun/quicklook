...
use commands::{
    ...
    get_default_program_name, get_epub_chapter, get_epub_info, get_monitor_info, get_mobi_content,
    get_mobi_info, get_pdf_outline, get_pdf_page_count, parse_lrc, read_audio_info,
    render_pdf_page, set_log_level, show_open_with_dialog,
};
